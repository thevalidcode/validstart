...
async function scaffoldHTMLCSS(options) {
    ...
    console.log(chalk.cyan(`\n📁 Creating basic HTML/CSS project: ${chalk.bold(projectName)}`));
...
<body>
  ...
  background-color: #f0f0f0;
    ...
    if (selectedTools.includes("TailwindCSS")) {
        console.log(chalk.yellow(`⚠️ TailwindCSS isn't auto-setup for raw HTML/CSS yet. You must configure it manually.`));
    }
